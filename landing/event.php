					...
					<div id="main">
						<!-- Post -->
							<section class="post">
								...
								<div class="image main"><img src="https://s3.amazonaws.com/community-templates/production/54b2bfc93e10a4b8f23055a7b5f825678de41a91.png" alt="" /></div>
<pre>
...
&lt;head&gt;<br />
	...
	&lt;title&gt;Event - [Plain HTML]&lt;/title&gt; &lt;!-- The title tag shows in email notifications, like Android 4.4. --&gt;<br />
<br />
...
<br />
								&lt;tr&gt;<br />
									...
									&lt;table&gt;<br />
										...
										<br />
												&lt;h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 30px; line-height: 36px; color: #ffffff; font-weight: bold;"&gt;OUR EVENT&lt;/h1&gt;<br />
											&lt;/td&gt;<br />
										&lt;/tr&gt;<br />
										&lt;tr&gt;<br />
												...
												&lt;table role="presentation" align="center" cellspacing="0" cellpadding="0" border="0" class="center-on-narrow" style="text-align: center;"&gt;<br />
													&lt;tr&gt;<br />
														&lt;td style="border-radius: 50px; background: #26a4d3; text-align: center;" class="button-td"&gt;<br />
															&lt;a href="http://www.google.com?utm_medium=email" style="background: #26a4d3; border: 15px solid #26a4d3; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 50px; font-weight: bold;" class="button-a"&gt;<br />
																&lt;span style="color:#ffffff;" class="button-link"&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;GET TICKETS&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&lt;/span&gt;<br />
															&lt;/a&gt;<br />
														&lt;/td&gt;<br />
													&lt;/tr&gt;<br />
												&lt;/table&gt;<br />
						...
						&lt;table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"&gt;<br />
							&lt;tr&gt;<br />
								&lt;td style="padding: 40px 40px 20px 40px; text-align: left;"&gt;<br />
									&lt;h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 20px; line-height: 26px; color: #333333; font-weight: bold;"&gt;YOU'VE BEEN INVITED TO THIS YEARS EVENT&lt;/h1&gt;<br />
								&lt;/td&gt;<br />
							&lt;/tr&gt;<br />
							&lt;tr&gt;<br />
...
<br />
				&lt;!-- AGENDA : BEGIN --&gt;<br />
				&lt;tr&gt;<br />
					&lt;td bgcolor="#f7fafc"&gt;<br />
						&lt;table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"&gt;<br />
							&lt;tr&gt;<br />
								&lt;td style="padding: 40px 40px 20px 40px; text-align: left;"&gt;<br />
									&lt;h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 20px; line-height: 26px; color: #333333; font-weight: bold;"&gt;AGENDA&lt;/h1&gt;<br />
								&lt;/td&gt;<br />
							&lt;/tr&gt;<br />
							&lt;tr&gt;<br />
								&lt;td style="padding: 0px 40px 35px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555; text-align: left; font-weight:normal;"&gt;<br />
									&lt;p style="margin: 0;"&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod<br />
									tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,<br />
									quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo<br />
									consequat.&lt;/p&gt;<br />
							...
							&lt;/tr&gt;<br />
							&lt;tr&gt;<br />
								&lt;td style="padding: 0px 40px 20px 40px;"&gt;<br />
									<br />
									&lt;table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" style="border:1px solid #dddddd; border-left:3px solid #26a4d3;"&gt;<br />
										&lt;tr&gt;<br />
											&lt;td align="" style="padding: 20px 20px 0px 20px; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 20px; color: #555555; text-align: left; font-weight:normal;"&gt;<br />
												&lt;h3 style="margin:0;"&gt;<br />
													Agenda 1).<br />
												&lt;/h3&gt;<br />
											&lt;/td&gt;<br />
										&lt;/tr&gt;<br />
										&lt;tr&gt;<br />
											&lt;td align="" style="padding: 20px 20px 20px 20px; font-family: sans-serif; font-size: 14px; line-height: 20px; color: #555555; text-align: left; font-weight:normal;"&gt;<br />
												&lt;p style="margin:0;"&gt;<br />
...
<br />
							...
							&lt;/tr&gt;<br />
							&lt;tr&gt;<br />
								&lt;td style="padding: 0px 40px 40px 40px;"&gt;<br />
									<br />
									&lt;table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" style="border:1px solid #dddddd; border-left:3px solid #26a4d3;"&gt;<br />
										&lt;tr&gt;<br />
											&lt;td align="" style="padding: 20px 20px 0px 20px; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 20px; color: #555555; text-align: left; font-weight:normal;"&gt;<br />
						...
						&lt;table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"&gt;<br />
							&lt;tr&gt;<br />
								&lt;td style="padding: 40px 40px 5px 40px; text-align: center;"&gt;<br />
									&lt;h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 20px; line-height: 24px; color: #ffffff; font-weight: bold;"&gt;ATTENDING OUR EVENT?&lt;/h1&gt;<br />
								&lt;/td&gt;<br />
							&lt;/tr&gt;<br />
							&lt;tr&gt;<br />
								&lt;td style="padding: 0px 40px 20px 40px; font-family: sans-serif; font-size: 17px; line-height: 23px; color: #aad4ea; text-align: center; font-weight:normal;"&gt;<br />
									&lt;p style="margin: 0;"&gt;Get tickets now before they sell out!&lt;/p&gt;<br />
								&lt;/td&gt;<br />
							&lt;/tr&gt;<br />
							&lt;tr&gt;<br />
									...
									&lt;table role="presentation" align="center" cellspacing="0" cellpadding="0" border="0" class="center-on-narrow"&gt;<br />
										&lt;tr&gt;<br />
											&lt;td style="border-radius: 50px; background: #ffffff; text-align: center;" class="button-td"&gt;<br />
												&lt;a href="http://www.google.com?utm_medium=email" style="background: #ffffff; border: 15px solid #ffffff; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 50px; font-weight: bold;" class="button-a"&gt;<br />
													&lt;span style="color:#26a4d3;" class="button-link"&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;GET TICKETS&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&lt;/span&gt;<br />
												&lt;/a&gt;<br />
											&lt;/td&gt;<br />
										&lt;/tr&gt;<br />
									&lt;/table&gt;<br />
