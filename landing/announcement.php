					...
					<div id="main">
						<!-- Post -->
							<section class="post">
								...
								<div class="image main"><img src="https://s3.amazonaws.com/community-templates/production/5e4af6f60debaed8f36bcf4642f6a9166076bc1e.png" alt="" /></div>
<pre>
...
&lt;head&gt;<br />
    ...
    &lt;title&gt;Announcement - [Plain HTML]&lt;/title&gt; &lt;!-- The title tag shows in email notifications, like Android 4.4. --&gt;<br />
<br />
                ...
                &lt;tr&gt;<br />
                    &lt;td bgcolor="#333333"&gt;<br />
                        &lt;table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"&gt;<br />
                            &lt;tr&gt;<br />
                                &lt;td style="padding: 30px 40px 30px 40px; text-align: center;" align="center"&gt;<br />
...
<br />
                                &lt;tr&gt;<br />
                                  ...
                                  &lt;table&gt;<br />
                                     ...
                                     <br />
                                             &lt;h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 30px; line-height: 36px; color: #ffffff; font-weight: bold;"&gt;ANNOUNCEMENT&lt;/h1&gt;<br />
                                         &lt;/td&gt;<br />
                                     &lt;/tr&gt;<br />
                                     &lt;tr&gt;<br />
                                                 ...
                                                 &lt;tr&gt;<br />
                                                     &lt;td style="border-radius: 50px; background: #26a4d3; text-align: center;" class="button-td"&gt;<br />
                                                         &lt;a href="http://www.google.com" style="background: #26a4d3; border: 15px solid #26a4d3; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 50px; font-weight: bold;" class="button-a"&gt;<br />
                                                             &lt;span style="color:#ffffff;" class="button-link"&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;VIEW UPDATES&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&lt;/span&gt;<br />
                                                         &lt;/a&gt;<br />
                                                     &lt;/td&gt;<br />
                                                 &lt;/tr&gt;<br />
                                             &lt;/table&gt;<br />
                        ...
                        &lt;table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"&gt;<br />
                            &lt;tr&gt;<br />
                                &lt;td style="padding: 40px 40px 20px 40px; text-align: left;"&gt;<br />
                                    &lt;h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 20px; line-height: 26px; color: #333333; font-weight: bold;"&gt;WE'VE GOT QUITE ALOT TO TALK ABOUT THIS MONTH&lt;/h1&gt;<br />
                                &lt;/td&gt;<br />
                            &lt;/tr&gt;<br />
                            &lt;tr&gt;<br />
                ...
                &lt;tr&gt;<br />
                    &lt;td bgcolor="#f7fafc"&gt;<br />
                        &lt;table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"&gt;<br />
                            &lt;tr&gt;<br />
                                &lt;td style="padding: 40px 40px 20px 40px; text-align: left;"&gt;<br />
                                    &lt;h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 20px; line-height: 26px; color: #333333; font-weight: bold;"&gt;LATEST NEWS&lt;/h1&gt;<br />
                                &lt;/td&gt;<br />
                            &lt;/tr&gt;<br />
                            &lt;tr&gt;<br />
                            ...
                            &lt;/tr&gt;<br />
                            &lt;tr&gt;<br />
                              &lt;td align="center" valign="top" style="padding: 0px 40px 0px 40px;"&gt;<br />
                                &lt;img src="http://placehold.it/600x250" width="600" height="" style="margin:0; padding:0; border:none; display:block;" border="0" class="fluid" alt=""&gt;<br />
                              &lt;/td&gt;<br />
                            &lt;/tr&gt;<br />
                            &lt;tr&gt;<br />
                                &lt;td style="padding: 0px 40px 20px 40px;"&gt;<br />
                                    <br />
                                    &lt;table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" style="border:1px solid #dddddd;"&gt;<br />
                                        &lt;tr&gt;<br />
                                        ...
                                        &lt;/tr&gt;<br />
                                        &lt;tr&gt;<br />
                                            &lt;td valign="top" align="left" style="text-align: left; padding: 0px 20px 20px 20px;"&gt;<br />
<br />
                                                &lt;!-- Button : BEGIN --&gt;<br />
                                                &lt;center&gt;<br />
                                                &lt;table role="presentation" align="left" cellspacing="0" cellpadding="0" border="0" style="text-align: left;"&gt;<br />
                                                    &lt;tr&gt;<br />
                                                        &lt;td style="border-radius: 50px; background: #26a4d3; text-align: center;" class="button-td"&gt;<br />
                                                            &lt;a href="http://www.google.com" style="background: #26a4d3; border: 15px solid #26a4d3; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 50px; font-weight: bold;" class="button-a"&gt;<br />
                                                                &lt;span style="color:#ffffff;" class="button-link"&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;READ MORE&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&lt;/span&gt;<br />
                                                            &lt;/a&gt;<br />
                                                        &lt;/td&gt;<br />
                                                    &lt;/tr&gt;<br />
                                                &lt;/table&gt;<br />
