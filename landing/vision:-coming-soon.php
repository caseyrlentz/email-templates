					...
					<div id="main">
						<!-- Post -->
							<section class="post">
								...
								<div class="image main"><img src="https://s3.amazonaws.com/community-templates/production/1dd4bc9596d5e47a58450097717d38e07633c40b.png" alt="" /></div>
<pre>
...
&lt;head&gt;<br />
    ...
    &lt;title&gt;Coming Soon - [Plain HTML]&lt;/title&gt; &lt;!-- The title tag shows in email notifications, like Android 4.4. --&gt;<br />
<br />
...
<br />
                                &lt;tr&gt;<br />
                                  ...
                                  &lt;table&gt;<br />
                                     ...
                                     <br />
                                             &lt;h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 30px; line-height: 36px; color: #ffffff; font-weight: bold;"&gt;COMING SOON&lt;/h1&gt;<br />
                                         &lt;/td&gt;<br />
                                     &lt;/tr&gt;<br />
                                     &lt;tr&gt;<br />
                                                 ...
                                                 &lt;tr&gt;<br />
                                                     &lt;td style="border-radius: 50px; background: #26a4d3; text-align: center;" class="button-td"&gt;<br />
                                                         &lt;a href="http://www.google.com" style="background: #26a4d3; border: 15px solid #26a4d3; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 50px; font-weight: bold;" class="button-a"&gt;<br />
                                                             &lt;span style="color:#ffffff;" class="button-link"&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;DISCOVER&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&lt;/span&gt;<br />
                                                         &lt;/a&gt;<br />
                                                     &lt;/td&gt;<br />
                                                 &lt;/tr&gt;<br />
                                             &lt;/table&gt;<br />
                        ...
                        &lt;table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"&gt;<br />
                            &lt;tr&gt;<br />
                                &lt;td style="padding: 40px 40px 20px 40px; text-align: left;"&gt;<br />
                                    &lt;h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 20px; line-height: 26px; color: #333333; font-weight: bold;"&gt;A QUICK LOOK AT WHAT'S COMING SOON&lt;/h1&gt;<br />
                                &lt;/td&gt;<br />
                            &lt;/tr&gt;<br />
                            &lt;tr&gt;<br />
